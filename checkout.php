...
if(isset($_POST['order'])){
   ...
   if($cart_total == 0){
      ...
      $insert_order->execute([$user_id, $name, $number, $email, $method, $address, $total_products, $cart_total, $placed_on,'success']);
...
<section class="checkout-orders">
   ...
   <form action="payment.php" method="POST">
      ...
      <?php
         echo '<input type="hidden" name="totalprice" value="' . $cart_grand_total . '">';
      ?>
